...
(* OASIS_START *)
(* DO NOT EDIT (digest: b19c17816039cdc30ca36d88957c7eb5) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "INI files parser and pretty printer";
          description = None;
          categories = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("re.pcre", None)];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ini"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "initrip.ml"; })
            ];
          plugins =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "l\169?2\155-\215T\169\21162\225@\022\202";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
